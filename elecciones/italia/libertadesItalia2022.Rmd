...
Se puede usar otro coeficiente como el **coeficiente Gamma** válido para variables ordinales. Los posibles resultados de Gamma son:
...
Este resultado de -0,747 debe interpretarse como una asociación negativa importante (-0,747 está más cerca del -1 que del 0 ) entre las dos variables de la tabla de contingencia.
