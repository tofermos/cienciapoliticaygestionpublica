...
de los años 2020 y 2022 (Ronda 10). Se escogerá en cada caso el test más
adecuado y, finalmente, se hará una valoración crítica a partir de los
datos analizados. Las variables que se estudiarán en las siguientes
...
Encuesta Social Europea, se creará el \emph{dataframe} de R. Esta será
...
Se comprueba que ya deben estar recodificados o al menos no aparecen. No
...
\tightlist
\item
  En primer lugar, se duplicarán los campos para hacer las
...
cruzada} mediante la función \emph{rbind}. En estas tablas, la variable
dependiente (``Los gays y lesbianas deberían tener libertad\ldots{}'')
se representa en las columnas y la independiente (``Me daría vergüenza
que un familiar cercano fuese gay o lesbiana''), en las filas.
...
\AttributeTok{caption=}\StringTok{"Opinión sobre la libertad de gays y lesbianas (según sentimiento}
\StringTok{de vergüenza por un familiar gay o lesbiana) (\% filas)"}\NormalTok{,}
...
\caption{Opinión sobre la libertad de gays y lesbianas (según
...
\emph{Fuente: Elaboración propia a partir de la Encuesta Social Europea
de los años 2020 y 2022 (Ronda 10. Preguntas A48 y A47)}
...
\item
  ...
  absoluto y 10, Es completamente válida)}. Esta es la \emph{variable
...
asociación mediante un coeficiente. La interpretación de los resultados
...
\textbf{Sobre el coeficiente:} Aunque el coeficiente, al ser negativo
