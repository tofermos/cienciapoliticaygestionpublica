...
A continuación veremos un sencillo ejemplo de uso de R Markdown en el que, a partir de un fichero *csv* con resultados electorales, crearemos y manipularemos objetos data.frame para obtener algunas medidas de tendencia central y dispersión que representaremos en tablas y gráficos.
