...
# Se ocultan mensajes instalación(message=FALSE)
...
```
Se ha reducido de `r ncol(df_cisjulio)` columnas a 1 sola.
...
# Para mejor la comprensión se puede cambiar los nombres de las columnas
# e imprimir la tabla con Rmd
