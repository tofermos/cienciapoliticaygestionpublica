...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tail}\NormalTok{(df\_cisjulio}\SpecialCharTok{$}\NormalTok{PROBVOTO,}\DecValTok{5}\NormalTok{) }\CommentTok{\# vemos solo 5 casos y los valores y etiquetas}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(df\_cisjulio}\SpecialCharTok{$}\NormalTok{PROBVOTO) }\CommentTok{\# Nos da el total de casos que tiene cada valor}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unique}\NormalTok{(df\_cisjulio}\SpecialCharTok{$}\NormalTok{PROBVOTO) }\CommentTok{\# Obtiene los valores sin duplicados}
\end{Highlighting}
\end{Shaded}
